...
- **Course Overview:** Reals and computations.
...
- **Floating-Point Arithmetic:** Motivation, numbers/operations.
    - [Numerical Computing with IEEE Floating Point Arithmetic](https://bpb-us-e1.wpmucdn.com/wp.nyu.edu/dist/8/24616/files/2024/01/RevisedBookForStudentsJan24.pdf?bid=24616) [2026, Overton] (§3–6).
- **Floating-Point Errors:** Manual error analysis, cancellation/overflow.
    - [Handbook of Floating-Point Arithmetic](https://link.springer.com/book/10.1007/978-3-319-76526-6) [2018, Muller+] (§2.3).
...
- **Arbitrary-Precision Evaluation:** Integer multiplication, power series.
    ...
    - [Modern Computer Arithmetic](https://www.cambridge.org/core/books/modern-computer-arithmetic/B345DF9E08B232BC5BAFE05C2F3A36D8) ([link](https://maths-people.anu.edu.au/~brent/pd/mca-cup-0.5.9.pdf)) [2012, Brent+] (§1.3, 3.3, 4.1, 4.3–4.4, 4.9).
-->
...
- **Discrete Distributions:** Inversion/alias method, entropy optimality.
    - [Darts, Dice, and Coins: Sampling from a Discrete Distribution](https://www.keithschwarz.com/darts-dice-coins/) [2011, Schwarz].
    - [Non-Uniform Random Variate Generation](https://link.springer.com/book/10.1007/978-1-4613-8643-8) [1986, DeVroye] (§15).
- **Markov Chain Monte Carlo:** Irreducibility, stationary distributions, aperiodicity, convergence.
...
- **Derivatives of Integrals:** Score/pathwise estimator.
    - [Monte Carlo Gradient Estimation in Machine Learning](https://jmlr.org/papers/v21/19-346.html) [2020, Mohamed+] (§??).
-->
